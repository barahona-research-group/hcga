...
def looplessness(graph):
    ...
    # Non-bipartite graphs
        ...
        LHS = [(l-1)*k for l,k in zip(trophic,in_degrees)]
        ...
        loop_exponent = np.log(branching_factor) + 1/(2*(exp_trophic_coher**2)) - 1/(2*(incoherence_parameter**2))
    
    return branching_factor, trophic, incoherence_parameter, exp_trophic_coher, exp_branching_factor, loop_exponent
