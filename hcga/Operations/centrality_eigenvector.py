...
class EigenCentrality():
    ...
    def feature_extraction(self):
        ...
        feature_list.append(eigenvector_centrality.max())
        feature_list.append(eigenvector_centrality.min())
        ...
        for i in range(len(bins)):
            ...
            feature_list.append(utils.power_law_fit(eigenvector_centrality,bins=bins[i])[0][-2]) # value 'a' in power law
            feature_list.append(utils.power_law_fit(eigenvector_centrality,bins=bins[i])[1]) # value sse in power law
