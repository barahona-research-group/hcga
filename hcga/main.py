...
class hcga:    
    ...
    def load_data(self,dataset='./datasets/ENZYMES.pkl',labels=None,dataset_name='custom_data',folder="./datasets"):
    ...
    def extract(self,n_workers=1,mode='slow',norm=False,stats_level="basic",runtimes=False):
    ...
    def analyse_features(self,feature_file='./results/features.pkl',output_folder="./results",
                      output_filename='features_analysis',interpretability=1,shap=True,classifier="RF",kfold=True,plot=True):
